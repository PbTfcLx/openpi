...
class RobocasaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        base_left_image = _parse_image(data["observation/image"])
        base_right_image = _parse_image(data["observation/right_image"])
        ...
        inputs = {
            ...
            "image": {
                "base_0_rgb": base_left_image,
                "base_1_rgb": base_right_image,
